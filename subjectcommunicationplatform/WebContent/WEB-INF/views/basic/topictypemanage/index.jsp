            ...
            $('#dg').bootstrapTable({
              ...
              //  striped: true,                      //是否显示行间隔色
                ...
                columns: [{field:'',title:'请选择',radio:true,sortable:true},
                	{field:'topicTypeId',title:'id',sortable:true},
                	{field:'topicTypeName',title:'话题名称',sortable:true},
                	{field:'topicTypeSubjectId',title:'所属学科id',sortable:true}
    				]
            });
        };
