    ...
    var TableInit = function () {
            ...
            $('#dg').bootstrapTable({
              ...
              //  striped: true,                      //是否显示行间隔色
                ...
                columns: [{field:'',title:'请选择',radio:true,sortable:true},
                	...
                	{field:'userPassword',title:'密码',sortable:true},
                	{field:'userHead',title:'头像地址',sortable:true},
                	{field:'userResPoint',title:'积分',sortable:true}
    				]
            });
            debugger;
        };
      ...
      oTableInit.queryParams = function (params) {
		...
		function Remove(){
			debugger;
			var row = $('#dg').bootstrapTable('getSelections');
			$.post(url+'remove',{id:row[0].userId},function(data){
				alert(data.message);
			});
