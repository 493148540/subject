    ...
    var TableInit = function () {
            ...
            $('#dg').bootstrapTable({
              ...
              //  striped: true,                      //是否显示行间隔色
                ...
                columns: [{field:'',title:'请选择',radio:true,sortable:true},
                	{field:'dictionariesId',title:'id',sortable:true},
                	{field:'dictionariesName',title:'名称',sortable:true},
                	{field:'dictionariesCode',title:'代码',sortable:true},
                	{field:'dictionariesTypeName',title:'类别名称',sortable:true},
                	{field:'dictionariesTypeCode',title:'类别代码',sortable:true},
    				]
            });
            debugger;
        };
      ...
      oTableInit.queryParams = function (params) {
		...
		function Remove(){
			debugger;
			var row = $('#dg').bootstrapTable('getSelections');
			$.post(url+'remove',{id:row[0].dictionariesId},function(data){
				alert(data.message);
			});
