    ...
    var TableInit = function () {
            ...
            $('#dg').bootstrapTable({
              ...
              //  striped: true,                      //是否显示行间隔色
                ...
                columns: [{field:'',title:'请选择',radio:true,sortable:true},
                	{field:'subjectId',title:'id',sortable:true},
                	{field:'subjectName',title:'学科名',sortable:true},
                	{field:'subjectType',title:'学科类别',sortable:true},
                	{field:'subjectCode',title:'类别编号',sortable:true}
    				]
            });
            debugger;
        };
      ...
      oTableInit.queryParams = function (params) {
		...
		function Remove(){
			debugger;
			var row = $('#dg').bootstrapTable('getSelections');
			$.post(url+'remove',{id:row[0].subjectId},function(data){
				alert(data.message);
			});
